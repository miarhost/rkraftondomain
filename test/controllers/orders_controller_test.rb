...
class OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should require item at cart" do
    get new_order_url
  ...
  test "should update order" do
    patch order_url(@order), params: { order: {  pay_type: @order. pay_type, address: @order.address, email: @order.email, integer: @order.integer, name: @order.name } }
